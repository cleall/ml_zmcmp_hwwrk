...
Later depending on which version you install you may have to fix keras imports as the version of keras has changed unless you specifically use the version in the lectures you have to fix the imports to use a newer version, what I did was use prefix:
...
Using the previous setup it is possible to use a pre-trained model to try out the notebook in the lectures using the homework data.
